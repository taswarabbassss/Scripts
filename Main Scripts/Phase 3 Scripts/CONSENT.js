  ...
  mainDataAssociationMethod() {
    ...
    for (
      ...
      sourceDocumentsList.forEach((sourceDocument) => {
        const associatedUser = this.getUserWithId(
...
const constructorParameters = {
  ...
  batchSize: 50,
  findQuery: {
    consentInformation: { $exists: true },
    "consentInformation.userId": { $exists: true },
    "consentInformation.type": { $ne: "NO_CONSENT" },
  },
};
...
/**
  ...
  1) getDetailDocument
  2) addSummaryDocumentWhenDetailDocAlreadyExists (change the dateCreated and dateModified)
  3) addNewDetailAndSummaryDocument (change the dateCreated and dateModified)
 */
